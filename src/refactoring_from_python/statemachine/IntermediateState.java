...
public abstract class IntermediateState extends AbstractState {
    public IntermediateState(String id) {
        this(id, new HashSet<>());
    }

    public IntermediateState(String id, Set<State> successors) {
        super(id, successors);
    }
}
